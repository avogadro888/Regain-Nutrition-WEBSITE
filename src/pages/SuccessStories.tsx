...
const SuccessStories = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Name here",
      rating: 5,
      comment: "Weight loss of Kgs.",
      detailedComment: "Weight loss of Kgs.",
      images: [
        "testimonials/new/tst13.png",
      ]
    },
    {
      id: 14,
