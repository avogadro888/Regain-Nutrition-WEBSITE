...
const Index = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      images: [  
        "testimonials/new/tst2.png",
        "testimonials/new/tst2_x.png",
      ]
    },
    {
      id: 3,
    ...
    },
    {
      ...
      images: [
        "testimonials/new/tst5.png",
        "testimonials/new/tst5_x.png",
      ]
    },
    {
      id: 6,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-white">
            ...
            <div className="animate-on-scroll opacity-0 text-center sm:text-left">
              ...
              >
                Hear more about our process <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="animate-on-scroll opacity-0">
              <div className="bg-gray-300 rounded-lg h-64 flex items-center justify-center">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3914.5234567890123!2d75.12345678901234!3d12.123456789012345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDA3JzI0LjQiTiA3NcKwMDcnMjQuNCJF!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
