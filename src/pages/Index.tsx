  ...
  const products = [
    {
      ...
      images: ["public/products/pd1.jpeg"],
    },
    {
      id: 2,
      ...
      images: ["public/products/pd2.jpeg"],
    },
    {
      id: 3,
      ...
      images: ["public/products/pd3.jpeg"],
    },
    {
      id: 4,
      name: "Energy Drink",
      ...
      images: ["public/products/pd4.jpeg"],
    },
    {
      id: 5,
      name: "Eye Health",
      ...
      images: ["public/products/pd5.jpeg"],
    },
    {
      id: 6,
      name: "Heart Health",
      ...
      images: ["public/products/pd6.jpeg"],
    },
  ];
  ...
  const testimonials = [
    {
      ...
      images: ["public/testimonials/tst1.png"],
    },
    {
      id: 2,
      name: "Augustine",
      ...
      images: [
        "public/testimonials/tst2.png",
        "public/testimonials/tst2_x.png",
      ],
    },
    {
      id: 3,
      ...
      detailedComment:
        "Check the body transformation after choosing our service.",
      images: ["public/testimonials/tst3.png"],
    },
    {
      id: 4,
      name: "E.P. Mercy",
      ...
      detailedComment:
        "EP Mercy achieved an incredible 18 kgs weight loss with the help of our personalized services.",
      images: ["public/testimonials/tst4.png"],
    },
    {
      id: 5,
      name: "Rajesh",
      ...
      detailedComment:
        "Rajesh achieved an incredible 18 kgs weight loss with the help of our personalized services.",
      images: [
        "public/testimonials/tst5.png",
        "public/testimonials/tst5_x.png",
      ],
    },
    {
      id: 6,
      ...
      detailedComment:
        "Rishikeshan achieved an incredible 12 kg weight loss with the help of our personalized services.",
      images: ["public/testimonials/tst6.png"],
    },
  ];
  ...
  const teamMembers = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b6bb6bae?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
      bio: "PhD in Nutritional Science with 15+ years experience",
      detailedBio:
        "Dr. Sarah Mitchell holds a PhD in Nutritional Science from Harvard University and has over 15 years of experience in clinical nutrition and sports performance. She has worked with Olympic athletes and published numerous research papers on protein synthesis and muscle recovery.",
    },
    {
      name: "Mark Johnson",
      ...
      detailedBio:
        "Mark Johnson is a former Olympic weightlifter who transitioned into sports nutrition research. With his firsthand experience in elite athletics and advanced degree in Exercise Physiology, he leads our product development team in creating cutting-edge supplements.",
    },
    {
      name: "Dr. Emily Chen",
      ...
      detailedBio:
        "Dr. Emily Chen is a certified biochemist with expertise in supplement manufacturing and quality control. She ensures every Regain Life Nutrition Centre product meets the highest standards of purity, potency, and safety through rigorous testing protocols.",
    },
  ];
  ...
  const activities = [
    {
      ...
      name: "Club Activity",
      description:
        "Comprehensive strength training routines designed for all fitness levels.",
      category: "Activity",
      testimonials: [
        {
    ...
    },
    {
      ...
      name: "Club Activity",
      description:
        "One-on-one sessions with certified nutritionists to optimize your diet.",
      category: "Activity",
      testimonials: [
        {
          name: "Regain Life Nutrition Centre, Valiyannur",
    ...
    },
    {
      ...
      name: "Club Activity",
      description:
        "High-intensity cardio workouts to improve cardiovascular health.",
      category: "Activity",
      testimonials: [
        {
          name: "Regain Life Nutrition Centre, Valiyannur",
    ...
    },
    {
      ...
      description:
        "Stretching and mobility sessions to improve range of motion.",
      category: "Activity",
      testimonials: [
        {
          name: "Regain Life Nutrition Centre, Valiyannur",
    ...
    },
    {
      ...
      description:
        "Learn to prepare healthy, nutritious meals for the week ahead.",
      category: "Activity",
      testimonials: [
        {
          name: "Regain Life Nutrition Centre, Valiyannur",
    ...
    },
    {
      ...
      description: "Motivating group sessions with various workout styles.",
      category: "Activity",
      testimonials: [
        {
          name: "Regain Life Nutrition Centre, Valiyannur",
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center mb-4">
                    {[...Array(selectedModal.data.rating)].map((_, i) => (
                      <MapPin key={i} className="w-5 h-5" />
                    ))}
                  </div>
